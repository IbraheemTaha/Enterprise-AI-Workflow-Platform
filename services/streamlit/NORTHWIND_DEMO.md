...
# Connection parameters from environment variables (see .env)
...
4. **Read the Full DBT Guide**: Check [DBT_README.md](./DBT_README.md) for architecture and best practices
